                    ...
                    <Card>
                        <div className='m-2'>
                            ...
                            <div className='m-2'>
                                ...
                                <input className='border-2 rounded-md p-2 w-full' type='password'/>
                            </div>
                            <div className='mx-2 mt-3 mb-0'>
                                <Link href='/'>
                                    <button className='bg-woymBlue text-white text-lg py-2 rounded-lg w-full'>Login</button>
                                </Link>
                            </div>
                            <div className='m-2 mt-0 text-center'>
                                <Link href='/register' className='hover:text-woymBlue hover:underline text-xs'>Sign up</Link>
